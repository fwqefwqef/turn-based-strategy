...
Class Passives:
Passives that are specific to the character and are learned on level up.
...
Equip passives will have an integer cost, even negative cost that will offset a more expensive passive. Class passives can be initialized as 0 cost but won't interact with passive cost and slots.
