...
{
    public class AreaConfirmUI : MonoBehaviour, CustomMoveAbility.IAreaConfirmUI
    {
        ...
        public void Show(
            ...
            string title,
            string description,
            IReadOnlyList<CustomMoveAbility.AreaConfirmTargetPreviewData> targetPreviews,
        ...
        private void RebuildTargetPreviewRows(IReadOnlyList<CustomMoveAbility.AreaConfirmTargetPreviewData> targetPreviews)
        {
            ClearTargetPreviewRows();
            ...
            foreach (CustomMoveAbility.AreaConfirmTargetPreviewData preview in targetPreviews)
            {
