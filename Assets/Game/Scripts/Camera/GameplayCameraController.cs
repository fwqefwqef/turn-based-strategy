...
namespace Windy.Srpg.Game.CameraControl
{
    public class GameplayCameraController : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            CustomUnit.CombatCameraFocusRequested += OnCombatCameraFocusRequested;
            CustomUnit.CombatCameraFocusReleased += OnCombatCameraFocusReleased;
        ...
        private Vector3 ResolveUnitFocusPosition(CustomUnit unit)
        {
            if (unit == null)
            {
        ...
        private void OnSelectionTargetChanged(CustomUnit unit)
        {
            if (unit != null)
            {
        ...
        private void OnInspectTargetChanged(CustomUnit unit)
        {
            if (unit != null)
            {
                SetFocusTarget(ResolveUnitFocusPosition(unit));
