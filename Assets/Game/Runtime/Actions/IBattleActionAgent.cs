...
namespace Windy.Srpg.Runtime.Actions
{
    ...
    {
        void InitializeAction(IBattleUnit unit);
        ...
        void OnUnitClicked(IBattleUnit unit, IBattleBoard board);
        void OnUnitHighlighted(IBattleUnit unit, IBattleBoard board);
        void OnUnitDehighlighted(IBattleUnit unit, IBattleBoard board);
