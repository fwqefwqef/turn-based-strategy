...
public class TradeMenuUI : GameplayModalUI, MoveAbility.ITradeMenuUI
{
    ...
    public void Show(Vector3 worldPosition, Unit selfUnit, Unit friendlyUnit, System.Action<bool> onClose, System.Action onFirstTradeCommitted)
    {
    ...
    private void BuildSideEntries(Unit unit, RectTransform dropdown, List<TradeItemRowView> rows, bool isSelfSide)
    {
    ...
    private static string BuildEntryLabel(Unit owner, Item entry)
    {
        if (entry?.Data == null)
        {
