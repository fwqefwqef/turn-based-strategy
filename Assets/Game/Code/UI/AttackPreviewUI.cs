...
namespace Windy.Srpg.Game.UI
{
    public class AttackPreviewUI : GameplayModalUI, MoveAbility.IAttackPreviewUI
    {
        ...
        public void Show(
            ...
            Unit attackerUnit,
            Unit defenderUnit,
            MoveAbility.AttackPreviewPanelData attacker,
            MoveAbility.AttackPreviewPanelData defender,
            ...
            System.Action onCancel)
        {
            ...
            GetOrderedPanels(
                ...
                attacker,
                defender,
                out MoveAbility.AttackPreviewPanelData leftData,
                out MoveAbility.AttackPreviewPanelData rightData,
        ...
        private static void GetOrderedPanels(
            Unit firstUnit,
            Unit secondUnit,
            MoveAbility.AttackPreviewPanelData firstData,
            MoveAbility.AttackPreviewPanelData secondData,
            out MoveAbility.AttackPreviewPanelData leftData,
            out MoveAbility.AttackPreviewPanelData rightData,
        ...
        private static string GetActionDisplayName(Unit unit)
        {
        ...
        private static void ApplyPanel(
            ...
            MoveAbility.AttackPreviewPanelData data,
