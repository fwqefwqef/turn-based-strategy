...
namespace Windy.Srpg.Runtime.Board
{
    public class BoardCell : MonoBehaviour, IBattleCell
    {
        ...
        private readonly List<BoardUnit> occupants = new List<BoardUnit>();
        ...
        public IReadOnlyList<BoardUnit> Occupants => occupants;
        ...
        public virtual bool CanOccupy(BoardUnit unit)
        {
            if (!isTraversable)
            {
                return false;
        ...
        public virtual bool TryAddOccupant(BoardUnit unit)
        {
        ...
        public virtual void RemoveOccupant(BoardUnit unit)
        {
            if (unit == null)
            {
                return;
