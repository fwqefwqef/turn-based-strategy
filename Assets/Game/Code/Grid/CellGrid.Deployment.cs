...
namespace Windy.Srpg.Game.Grid
{
    public partial class CellGrid
    {
        ...
        public void HandlePreBattleDeploymentCellClicked(BattleSquareCell cell)
        {
        ...
        private string[] GetCurrentSceneDeploymentRosterRaw(int deploymentSlotCount)
        {
            ...
            Dictionary<BattleSquareCell, Unit> friendlyUnitsByCell = GetFriendlyDeploymentUnits()
        ...
        private void RegisterDeploymentUnitForBattle(Unit unit, BattleSquareCell targetCell)
        {
            if (unit == null
                || targetCell == null
        ...
        private static void AssignDeploymentUnitToSlot(Unit unit, DeploymentSlot slot)
        {
            ...
            BattleSquareCell previousCell = unit.Cell;
            BattleSquareCell nextCell = slot.Cell;
        ...
        private static void ReleaseDeploymentUnitCell(Unit unit)
        {
            ...
            BattleSquareCell currentCell = unit.Cell;
        ...
        private bool TryGetDeploymentSlotIndexForCell(BattleSquareCell cell, out int slotIndex)
        {
            slotIndex = -1;
            if (cell == null)
            {
        ...
        private static void RefreshDeploymentCellOccupancy(BattleSquareCell cell)
        {
