...
namespace Windy.Srpg.Runtime.Board.States
{
    public abstract class BoardState
    {
        ...
        /// </summary>
        public virtual BoardUnit SelectedUnit => null;
        ...
        public virtual void OnUnitClicked(BoardUnit unit)
        {
        }

        public virtual void OnUnitHovered(BoardUnit unit)
        {
        }

        public virtual void OnUnitUnhovered(BoardUnit unit)
        {
        }
