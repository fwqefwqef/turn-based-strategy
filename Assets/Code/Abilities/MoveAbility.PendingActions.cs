        ...
        private static bool SkillMatchesWeapon(SkillData data, WeaponData weapon)
        {
            ...
            switch (data.RequiredWeaponType)
            {
                case CombatArtWeaponType.Any:
                    return true;
                case CombatArtWeaponType.Melee:
                    return WeaponProficiencyUtility.ForWeapon(weapon) == WeaponProficiency.Melee;
                case CombatArtWeaponType.Ranged:
                    return WeaponProficiencyUtility.ForWeapon(weapon) == WeaponProficiency.Ranged;
                case CombatArtWeaponType.Magic:
                    return WeaponProficiencyUtility.ForWeapon(weapon) == WeaponProficiency.Magic;
                default:
                    return false;
            }
        }
