...
namespace Windy.Srpg.Game.Abilities
{
    public partial class MoveAbility : Ability
    {
        ...
        {
            void Show(Vector3 worldPosition, bool showAttack, bool showHeal, bool showSkill, bool showItem, bool showTrade, bool showOvercharge, System.Action onAttack, System.Action onHeal, System.Action onSkill, System.Action onItem, System.Action onTrade, System.Action onOvercharge, System.Action onWait, System.Action onCancel);
            void Hide();
        }
        ...
        private void ShowActionMenu(CellGrid cellGrid)
        {
            ...
            actionMenuUi.Show(
                ...
                showItem: showItem,
                showTrade: showTrade,
                showOvercharge: UnitReference.CanActivateOvercharge,
