...
namespace Windy.Srpg.Game.Editor
{
    ...
    {
        private const string DefaultEnemyPresetFolder = "Assets/Data/Preset Data (Unit, Tile)/enemy preset";
        private const string DefaultFriendlyPresetFolder = "Assets/Data/Preset Data (Unit, Tile)/friendly preset";
