...
namespace Windy.Srpg.Game.Editor
{
    internal static class OverworldMenuSceneBuilder
    {
        ...
        private static void CreateOverworldMenuScene()
        {
            ...
            Button resetSaveButton = CreateButton(rootPanel, "Reset Save", new Vector2(92f, -462f), new Vector2(160f, 34f));
            Button quitButton = CreateButton(rootPanel, "Quit", new Vector2(268f, -462f), new Vector2(160f, 34f));

            overworldMenu.EditorConfigure(canvas, rootPanel, content, levelButtonTemplate, resetSaveButton, quitButton);
