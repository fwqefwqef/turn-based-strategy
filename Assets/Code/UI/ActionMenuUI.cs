...
public class ActionMenuUI : Windy.Srpg.Game.UI.GameplayModalUI, IActionMenuUI
{
    ...
    private System.Action _onOvercharge;
    ...
    protected override void Awake()
    {
        ...
        {
            overchargeButton.onClick.AddListener(() => _onOvercharge?.Invoke());
        }
        if (waitButton != null)
        {
    ...
    public void Show(Vector3 worldPosition, bool showAttack, bool showHeal, bool showSkill, bool showItem, bool showTrade, bool showOvercharge, System.Action onAttack, System.Action onHeal, System.Action onSkill, System.Action onItem, System.Action onTrade, System.Action onOvercharge, System.Action onWait, System.Action onCancel)
    {
        _onAttack = onAttack;
        _onHeal = onHeal;
        _onSkill = onSkill;
        ...
        if (overchargeButton != null)
        {
            overchargeButton.gameObject.SetActive(showOvercharge);
        }
    ...
    private void RepositionVisibleButtons()
    {
        ...
        RepositionButton(overchargeButton, ref nextY);
