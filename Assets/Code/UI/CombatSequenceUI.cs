...
namespace Windy.Srpg.Game.UI
{
    public class CombatSequenceUI : MonoBehaviour
    {
        ...
        private bool showingTurnStartHealthPhase;

        public void ShowTurnStartHealthPhase(Unit unit)
        {
            if (unit == null) return;
            OnCombatSequenceStarted(this, new CombatSequenceEventArgs(unit, unit));
            showingTurnStartHealthPhase = true;
        ...
        private void OnEnable()
        {
            ...
            Unit.CombatSequenceEnded += OnCombatSequenceEnded;
        }
        ...
        {
            showingTurnStartHealthPhase = false;
        ...
        private void SetCombatants(Unit attacker, Unit defender)
        {
        ...
        {
            RefreshPanels();
            if (showingTurnStartHealthPhase) return;
        ...
        {
            GetOrderedCombatants(out Unit leftUnit, out Unit rightUnit);
        ...
        private void RefreshPanel(UnitPanelBindings panel, Unit unit)
        {
        ...
        private void UpdatePanelGradient(UnitPanelBindings panel, Unit unit, int maxHitPoints)
        {
        ...
        private void GetGradientColors(Unit unit, int maxHitPoints, out Color startColor, out Color endColor)
        {
            if (unit == null)
            {
        ...
        private static int GetDisplayedMaxHitPoints(Unit unit)
        {
            if (unit == null)
            {
                return 1;
        ...
        private void GetOrderedCombatants(out Unit leftUnit, out Unit rightUnit)
        {
        ...
        private static bool ShouldDisplayFirstUnitOnLeft(Unit firstUnit, Unit secondUnit)
        {
            if (firstUnit == null)
            {
                return false;
        ...
        private static float GetPreviewOrCurrentX(Unit unit)
        {
            if (unit == null)
            {
                return 0f;
        ...
        private static float GetOriginalX(Unit unit)
        {
            if (unit?.Cell != null)
            {
