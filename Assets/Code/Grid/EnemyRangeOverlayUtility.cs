    ...
    internal static class EnemyRangeOverlayUtility
    {
        ...
        private static bool SkillMatchesWeapon(SkillData data, WeaponData weapon)
        {
            ...
            return data.RequiredWeaponType switch
            {
                ...
                CombatArtWeaponType.Melee => WeaponProficiencyUtility.ForWeapon(weapon) == WeaponProficiency.Melee,
                CombatArtWeaponType.Ranged => WeaponProficiencyUtility.ForWeapon(weapon) == WeaponProficiency.Ranged,
                CombatArtWeaponType.Magic => WeaponProficiencyUtility.ForWeapon(weapon) == WeaponProficiency.Magic,
                _ => false
            };
        }
    }
