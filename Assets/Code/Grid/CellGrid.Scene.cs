...
namespace Windy.Srpg.Game.Grid
{
    public partial class CellGrid
    {
        ...
        {
            // Resolve regeneration and Pain together for the incoming side,
            // including units that will be unable to act this turn.
            ...
            foreach (Unit unit in GetAllUnits().Where(unit => unit != null && unit.PlayerNumber == currentPlayerNumber).ToList())
            {
                ...
                if (unit != null && unit.IsAliveForBattle) yield return unit.PresentTurnStartHealthPhase();
            }
