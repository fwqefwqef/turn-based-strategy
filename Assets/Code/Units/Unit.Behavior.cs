...
namespace Windy.Srpg.Game.Units
{
    public partial class Unit
    {
        ...
        public IEnumerator PresentTurnStartHealthPhase()
        {
            bool hasHealthEffects = (BuffList?.HasTurnStartHealthEffects() ?? false)
                || HasPassiveTurnStartHealthEffects();
            if (!IsAliveForBattle || !hasHealthEffects)
                yield break;
